...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/MoulatiMehdi/oh-my-bash/master/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/MoulatiMehdi/oh-my-bash/master/tools/install.sh -O -)"
```
...
Oh My Bash comes with a shit load of plugins to take advantage of. You can take a look in the [plugins](https://github.com/MoulatiMehdi/oh-my-bash/tree/master/plugins) directory and/or the [wiki](https://github.com/MoulatiMehdi/oh-my-bash/wiki/Plugins) to see what's currently available.
...
We'll admit it. Early in the Oh My Bash world, we may have gotten a bit too theme happy. We have over one hundred themes now bundled. Most of them have [screenshots](https://github.com/MoulatiMehdi/oh-my-bash/wiki/Themes) on our wiki or alternatively [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/wiki/themes) wiki.
...
# see https://github.com/MoulatiMehdi/oh-my-bash/wiki/Themes#agnoster
```
...
at the wiki for [more of them](https://github.com/MoulatiMehdi/oh-my-bash/wiki/Themes).
...
```shell
export OSH="$HOME/.dotfiles/oh-my-bash"; bash -c "$(curl -fsSL https://raw.githubusercontent.com/MoulatiMehdi/oh-my-bash/master/tools/install.sh)"
```
...
```sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/MoulatiMehdi/oh-my-bash/master/tools/install.sh)" --unattended
```
...
```sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/MoulatiMehdi/oh-my-bash/master/tools/install.sh)" --prefix=/usr/local
```
...
```shell
git clone https://github.com/MoulatiMehdi/oh-my-bash.git ~/.oh-my-bash
```
...
(`github.com/MoulatiMehdi/oh-my-bash`) in upgrading.
...
issues](https://github.com/MoulatiMehdi/oh-my-bash/issues) and help where you can.
